...
"""
    ...
    ansible_changelog.add_fragment_line("bugfix.yml", "bugfixes", ["A bugfix."])
        ...
        "test_callback": {
            "doc": {
                ...
                "filename": os.path.join(
                    "lib", "ansible", "plugins", "callback", "test_callback.py"
                ),
                "name": "test_callback",
                "options": {},
    ...
    "module": {
        "old_module": {
            "doc": {
                ...
                "filename": os.path.join(
                    "lib", "ansible", "modules", "cloud", "sky", "old_module.py"
                ),
                "name": "old_module",
                "options": {},
...
"""
        ...
        assert (
            plugin_cache["plugins"]["module"]["test_module"]["version_added"] == "2.10"
        )
