...
antsibull-changelog depends on the sister antsibull-docutils project. By default, `nox`
...
- `OTHER_ANTSIBULL_MODE=local` — install the project from `../antsibull-docutils`. Fail if
